...
global.caption = "*ZEROCOOL MD V1*"; // Input Yours custom...(Maintain font for Flow)
...
global.footer = "*ᴘᴏᴡᴇʀᴇᴅ ʙʏ ZEROCOOL ᴛᴇᴄʜ*"; // Input Yours custom...(Maintain font for Flow)
...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~0ZeG8BHx7XTrPaQeqknG", // Add sess Id here especially when deploying on panels else use app.json and .env file...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "254703751163", // Only 1 owner Number Here, others Add to sudo numbers...
...
BOT_NAME: process.env.BOT_NAME || "ZEROCOOL-MD", // Input Yours custom...(Maintain font for Flow)
BOT_PIC: process.env.BOT_PIC || "https://i.pinimg.com/1200x/a5/79/8b/a5798b7b8efaa02003b4272be765b3e8.jpg", // You can Replace with yours...
